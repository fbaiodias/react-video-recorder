...
var _PrimaryButton = _interopRequireDefault(require("./defaults/PrimaryButton"));
...
var VideoRecorder = /*#__PURE__*/function (_PureComponent) {
  _inherits(VideoRecorder, _PureComponent);
  ...
  _createClass(VideoRecorder, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          PrimaryButtonComponent = _this$props3.PrimaryButtonComponent;
      return /*#__PURE__*/_react["default"].createElement(Wrapper, null, this.renderCameraView(), /*#__PURE__*/_react["default"].createElement(Actions, {
        isVideoInputSupported: isVideoInputSupported,
        isInlineRecordingSupported: isInlineRecordingSupported,
...
_defineProperty(VideoRecorder, "defaultProps", {
  ...
  Actions: _renderActions["default"],
  isFlipped: true,
  countdownTime: 3000,
  constraints: CONSTRAINTS,
  chunkSize: 250,
  dataAvailableTimeout: 500,
  PrimaryButtonComponent: _PrimaryButton["default"]
});