...
exports.ReactVideoRecorderMediaRecorderUnavailableError = exports.ReactVideoRecorderDataAvailableTimeoutError = exports.ReactVideoRecorderRecordedBlobsUnavailableError = exports.ReactVideoRecorderDataIssueError = void 0;
...
var ReactVideoRecorderDataIssueError =
/*#__PURE__*/
function (_Error) {
  ...
  function ReactVideoRecorderDataIssueError(event) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactVideoRecorderDataIssueError).call(this, "Couldn't get data from event"));
...
var ReactVideoRecorderRecordedBlobsUnavailableError =
/*#__PURE__*/
function (_Error2) {
  ...
  function ReactVideoRecorderRecordedBlobsUnavailableError(event) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ReactVideoRecorderRecordedBlobsUnavailableError).call(this, "Couldn't get recordedBlobs"));
...
var ReactVideoRecorderDataAvailableTimeoutError =
/*#__PURE__*/
function (_Error3) {
  ...
  function ReactVideoRecorderDataAvailableTimeoutError(dataAvailableTimeout) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(ReactVideoRecorderDataAvailableTimeoutError).call(this, "Method mediaRecorder.ondataavailable wasn't called after ".concat(dataAvailableTimeout, "ms")));
...
var ReactVideoRecorderMediaRecorderUnavailableError =
/*#__PURE__*/
function (_Error4) {
  ...
  function ReactVideoRecorderMediaRecorderUnavailableError() {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ReactVideoRecorderMediaRecorderUnavailableError).call(this, "Couldn't get mediaRecorder"));
